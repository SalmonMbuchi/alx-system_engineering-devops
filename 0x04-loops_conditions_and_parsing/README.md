...
* **1. For Holberton School loop**
  * [1-for_holberton_school](./1-for_best_school): Bash script that displays
  `Holberton School` 10 times using a `for` loop.

* **2. While Holberton School loop**
  * [2-while_holberton_school](./2-while_best_school): Bash script that
  displays `Holberton School` 10 times using a `while` loop.

* **3. Until Holberton School loop**
  * [3-until_holberton_school](./3-best_school): Bash script that displays
