...
In this project, I was tasked with setting up an application server, plugging it to Nginx and serving Airbnb clone project.
...
**3.Add a route with query parameters**: [3-app_server-nginx_config](./2-app_server-nginx_config)
